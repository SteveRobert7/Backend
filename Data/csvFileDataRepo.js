...
csvFileDataRepo = {
  Get: (req) => {
    let studentsList = readAllStudents();
...
module.exports = csvFileDataRepo;
...
function inputNewStudent(req) {
  ...
  let newstudentsList = readAllStudents();
...
function editStudent(req) {
  ...
  if (studentId) {
    studentsList[studentId].name = inputBody.name
      ? inputBody.name
      : studentsList[studentId].name;
    studentsList[studentId].standard = inputBody.standard
      ? inputBody.standard
      : studentsList[studentId].standard;
